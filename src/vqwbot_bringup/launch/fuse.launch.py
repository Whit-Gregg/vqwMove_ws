...
def generate_launch_description():
    ...
    ld.add_action(launch.actions.DeclareLaunchArgument(name='tf_timeout', default_value='500000000.0', description='the timeout waiting for a transform to be available'))
