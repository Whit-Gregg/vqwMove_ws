#pragma once
#include "vqwMsgCallbackHolder.h"
#include "vqwPipe.h"
#include "vqwSerializer.h"
#include <map>
#include <string>
#include <vector>
...
namespace vqw
{
    ...
    class vqwPipe_Channel
    {
      public:
        ...
        void init()
        {
            pPipe->set_ChannelData_callback(channel_number, [this](const ChannelDataHeader_t *pData) { this->myChannelData_callback(pData); });
        }
        ...
        int Send_ChannelData_message(MsgType *pMsg)
        {
            ...
            uint8_t                 buf[vqwPipe::recv_msg_max_size];
            ...
            return pPipe->sendChannelDataMsg((const ChannelDataHeader_t *)(&(pCDM->hdr)));
        }
        //=+-~=+-~=+-~=+-~=+-~=+-~=+-~=+-~=+-~=+-~=+-~=+-~=+-~=+-~=+-~=+-~=+-~=+-~=+-~=+-~=+-~=+-~=+-~=+-~=+-~=+-~
