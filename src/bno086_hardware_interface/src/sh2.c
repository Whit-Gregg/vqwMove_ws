...
static void sensorhubControlHdlr(void *cookie, uint8_t *payload, uint16_t len, [[maybe_unused]] uint32_t timestamp)
{
    sh2_t *pSh2 = (sh2_t *)cookie;
...
static void executableAdvertHdlr([[maybe_unused]] void *cookie, [[maybe_unused]] uint8_t tag, [[maybe_unused]] uint8_t len, [[maybe_unused]] uint8_t *value)
{
    // Ignore.  No known TLV tags for this app.
}

static void executableDeviceHdlr(void *cookie, uint8_t *payload, uint16_t len, [[maybe_unused]] uint32_t timestamp)
{
    sh2_t *pSh2 = (sh2_t *)cookie;
...
static void getProdIdRx(sh2_t *pSh2, const uint8_t *payload, [[maybe_unused]] uint16_t len)
{
...
static void getSensorConfigRx(sh2_t *pSh2, const uint8_t *payload, [[maybe_unused]] uint16_t len)
{
...
static void getFrsRx(sh2_t *pSh2, const uint8_t *payload, [[maybe_unused]] uint16_t len)
{
...
static void setFrsRx(sh2_t *pSh2, const uint8_t *payload, [[maybe_unused]] uint16_t len)
{
...
static void getErrorsRx(sh2_t *pSh2, const uint8_t *payload, [[maybe_unused]] uint16_t len)
{
...
static void getCountsRx(sh2_t *pSh2, const uint8_t *payload, [[maybe_unused]] uint16_t len)
{
    CommandResp_t *resp = (CommandResp_t *)payload;
...
static void reinitRx(sh2_t *pSh2, const uint8_t *payload, [[maybe_unused]] uint16_t len)
{
    CommandResp_t *resp = (CommandResp_t *)payload;
...
static void saveDcdNowRx(sh2_t *pSh2, const uint8_t *payload, [[maybe_unused]] uint16_t len)
{
    CommandResp_t *resp = (CommandResp_t *)payload;
...
static void getOscTypeRx(sh2_t *pSh2, const uint8_t *payload, [[maybe_unused]] uint16_t len)
{
    CommandResp_t *resp = (CommandResp_t *)payload;
    sh2_OscType_t *pOscType;
...
static void setCalConfigRx(sh2_t *pSh2, const uint8_t *payload, [[maybe_unused]] uint16_t len)
{
    CommandResp_t *resp = (CommandResp_t *)payload;
...
static void getCalConfigRx(sh2_t *pSh2, const uint8_t *payload, [[maybe_unused]] uint16_t len)
{
    CommandResp_t *resp = (CommandResp_t *)payload;
...
static void forceFlushRx(sh2_t *pSh2, const uint8_t *payload, [[maybe_unused]] uint16_t len)
{
...
static void startCalRx(sh2_t *pSh2, const uint8_t *payload, [[maybe_unused]] uint16_t len)
{
    CommandResp_t *resp = (CommandResp_t *)payload;
...
static void finishCalRx(sh2_t *pSh2, const uint8_t *payload, [[maybe_unused]] uint16_t len)
{
    CommandResp_t *resp = (CommandResp_t *)payload;
...
static void shtpEventCallback([[maybe_unused]] void *cookie, shtp_Event_t shtpEvent) {
    sh2_t *pSh2 = &_sh2;
...
int sh2_getMetadata(sh2_SensorId_t sensorId, sh2_SensorMetadata_t *pData)
{
    ...
    int i;
    for (i = 0; i < (int)ARRAY_LEN(sensorToRecordMap); i++) {
        if (sensorToRecordMap[i].sensorId == sensorId) {
            break;
        }
    }
    if (i >= (int)ARRAY_LEN(sensorToRecordMap)) {
        // no match was found
 ...
 * @return SH2_OK (0), on success.  Negative value from sh2_err.h on error.
 */
int sh2_finishCal([[maybe_unused]] sh2_CalStatus_t *status)
{
    sh2_t *pSh2 = &_sh2;
